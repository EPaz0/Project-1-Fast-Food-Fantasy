...
#include "ui_alltwelvetrip.h"
#include <QInputDialog>
#include <QMessageBox>

alltwelvetrip::alltwelvetrip(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::alltwelvetrip)
{
    ui->setupUi(this);
    ...
    if(qry.exec())
    {
        while(qry.next())
        {
           QString restName = qry.value(0).toString();
...
alltwelvetrip::~alltwelvetrip()
{
    delete ui;
}

QString alltwelvetrip::AddApostropheToString(QString restaurantname)
{
...
QString alltwelvetrip::GetRestaurantNameUsingQSL(int id)
{
    QString name;
...
int alltwelvetrip::GetRestaurantIDUsingQSL(QString name)
{
    int id = 0;
...
void alltwelvetrip::on_pushButton_clicked()
{
...
void alltwelvetrip::on_pushButton_2_clicked()
{
...
void alltwelvetrip::on_pushButton_3_clicked()
{
    db.close();
    const QString connectionName = db.connectionName();
    db = QSqlDatabase();
...
void alltwelvetrip::on_pushButton_4_clicked()
{
...
void alltwelvetrip::on_pushButton_5_clicked()
{
    /*
...
void alltwelvetrip::on_pushButton_6_clicked()
{
    db.close();
    const QString connectionName = db.connectionName();
    db = QSqlDatabase();
