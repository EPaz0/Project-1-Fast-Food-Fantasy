...
int main(int argc, char *argv[])
{
    ...
    if(!query.exec("CREATE TABLE IF NOT EXISTS menu (restaurantID INTEGER, item TEXT, price FLOAT)"))
    ...
    if(!query.exec("CREATE TABLE IF NOT EXISTS distances ('fromRestaurant' INTEGER, 'toRestaurant' INTEGER, 'distance' FLOAT)"))
